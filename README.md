...
- на сервере должен быть установлен Git. Для проверки выполнить `sudo apt update` `git --version`, если Git не установлен - установить командой `sudo apt install git`
